...
export type Assignment = {
  ...
  self_prediction_set_at?: string | null;
  self_prediction_outcome?: SelfPredictionOutcome | null;
  /** Cached 1-sentence "the ask in plain English" summary, generated by
   *  services/assignment_summary.py via Claude. Populated lazily when
   *  the AuditDrawer is opened. May be null when body is too short or
